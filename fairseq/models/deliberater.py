...
from fairseq.models.transformer import TransformerEncoder, TransformerDecoder, TransformerModel, Embedding, Linear
...
@register_model("deliberater")
class DeliberaterModel(TransformerModel):
    """
    Args:
        encoder (TransformerEncoder): the encoder
        decoder (DeliberaterDecoder): the decoder
...
class DeliberaterDecoder(TransformerDecoder):
    def __init__(self, args, dictionary, embed_tokens, no_encoder_attn=False):
        ...
        if self.decoder_layerdrop > 0.0:
            self.deliberate_layers = LayerDropModuleList(p=self.decoder_layerdrop)
        else:
    ...
    def extract_features_scriptable(
        ...
        return residual, {"attn": [attn], "inner_states": inner_states,
                          "de_attn": [de_attn], "de_inner_states": de_inner_states,
                          "dec_out": dec_out}
...
@register_model_architecture("deliberater", "deliberater")
